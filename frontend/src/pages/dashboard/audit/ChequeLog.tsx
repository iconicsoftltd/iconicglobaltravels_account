...
const ChequeLogPage: React.FC = () => {
  ...
  const {
    data: singleLogData,
  } = useGetChequeLogByIdQuery(selectedLogId, { skip: !selectedLogId });

  const logs: ChequeLogType[] = logData?.data || [];
  ...
  const columns: ColumnDef<ChequeLogType>[] = [
    {
      id: "sl",
      header: "SL",
