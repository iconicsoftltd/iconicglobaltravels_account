...
const VoucherLogPage: React.FC = () => {
  ...
  const {
    data: singleLogData,
  } = useGetVoucherLogByIdQuery(selectedLogId, { skip: !selectedLogId });

  const logs: VoucherLogType[] = logData?.data || [];
  ...
  const columns: ColumnDef<VoucherLogType>[] = [
    {
      id: "sl",
      header: "SL",
