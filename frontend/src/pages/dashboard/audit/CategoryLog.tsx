...
const CategoryLogPage: React.FC = () => {
  ...
  const {
    data: singleLogData,
  } = useGetCategoryLogByIdQuery(selectedLogId, { skip: !selectedLogId });

  const logs: CategoryLogType[] = logData?.data || [];
  ...
  const columns: ColumnDef<CategoryLogType>[] = [
    {
      id: "sl",
      header: "SL",
...
export default CategoryLogPage;
