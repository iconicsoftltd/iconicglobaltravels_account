...
const PurchaseLogPage: React.FC = () => {
  ...
  const {
    data: singleLogData,
  } = useGetPurchaseLogByIdQuery(selectedLogId, { skip: !selectedLogId });

  const logs: PurchaseLogType[] = logData?.data || [];
  ...
  const columns: ColumnDef<PurchaseLogType>[] = [
    {
      id: "sl",
      header: "SL",
