...
const SalaryLogPage: React.FC = () => {
  ...
  const {
    data: singleLogData,
  } = useGetSalaryLogByIdQuery(selectedLogId, { skip: !selectedLogId });

  const logs: SalaryLogType[] = logData?.data || [];
  ...
  const columns: ColumnDef<SalaryLogType>[] = [
    {
      id: "sl",
      header: "SL",
