...
const ColorLogPage: React.FC = () => {
  ...
  const {
    data: singleLogData,
  } = useGetColorLogByIdQuery(selectedLogId, { skip: !selectedLogId });

  const logs: ColorLogType[] = logData?.data || [];
  ...
  const columns: ColumnDef<ColorLogType>[] = [
    {
      id: "sl",
      header: "SL",
