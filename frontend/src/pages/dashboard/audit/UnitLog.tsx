...
const UnitLogPage: React.FC = () => {
  ...
  const {
    data: singleLogData,
  } = useGetUnitLogByIdQuery(selectedLogId, { skip: !selectedLogId });

  const logs: UnitLogType[] = logData?.data || [];
  ...
  const columns: ColumnDef<UnitLogType>[] = [
    {
      id: "sl",
      header: "SL",
