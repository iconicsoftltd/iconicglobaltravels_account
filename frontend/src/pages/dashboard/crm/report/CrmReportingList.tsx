...
const CrmReportingListPage = () => {
    ...
    const columns: ColumnDef<TodaysCall>[] = [
        ...
        {
            accessorKey: "id",
            header: "Index No.", // Corrected to match the image
    ...
    return (
        <div className="bg-white">
            ...
            {/* Header Section */}
            <Heading children="Project Wise Report" className=" font-semibold text-center mb-[14px]" />
...
export default CrmReportingListPage;
