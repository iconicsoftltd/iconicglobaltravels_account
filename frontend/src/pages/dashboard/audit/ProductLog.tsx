...
const ProductLogPage: React.FC = () => {
  ...
  const {
    data: singleLogData,
  } = useGetProductLogByIdQuery(selectedLogId, { skip: !selectedLogId });

  const logs: ProductLogType[] = logData?.data || [];
  ...
  const columns: ColumnDef<ProductLogType>[] = [
    {
      id: "sl",
      header: "SL",
