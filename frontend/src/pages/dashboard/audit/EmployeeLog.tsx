...
const EmployeeLogPage: React.FC = () => {
  ...
  const {
    data: singleLogData,
  } = useGetEmployeeLogByIdQuery(selectedLogId, { skip: !selectedLogId });

  const logs: EmployeeLogType[] = logData?.data || [];
  ...
  const columns: ColumnDef<EmployeeLogType>[] = [
    {
      id: "sl",
      header: "SL",
