...
const BrandLogPage: React.FC = () => {
  ...
  const {
    data: singleLogData,
  } = useGetBrandLogByIdQuery(selectedLogId, { skip: !selectedLogId });

  const logs: BrandLogType[] = logData?.data || [];
  ...
  const columns: ColumnDef<BrandLogType>[] = [
    {
      id: "sl",
      header: "SL",
