...
const BankLogPage: React.FC = () => {
  ...
  const {
    data: singleLogData,
  } = useGetBankLogByIdQuery(selectedLogId, { skip: !selectedLogId });

  const logs: BankLogType[] = logData?.data || [];
  ...
  const columns: ColumnDef<BankLogType>[] = [
    {
      id: "sl",
      header: "SL",
