...
const SizeLogPage: React.FC = () => {
  ...
  const {
    data: singleLogData,
  } = useGetSizeLogByIdQuery(selectedLogId, { skip: !selectedLogId });

  const logs: SizeLogType[] = logData?.data || [];
  ...
  const columns: ColumnDef<SizeLogType>[] = [
    {
      id: "sl",
      header: "SL",
