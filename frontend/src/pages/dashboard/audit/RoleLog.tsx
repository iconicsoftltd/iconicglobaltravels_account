...
const RoleLogPage: React.FC = () => {
  ...
  const {
    data: singleLogData,
  } = useGetRoleLogByIdQuery(selectedLogId, { skip: !selectedLogId });

  const logs: RoleLogType[] = logData?.data || [];
  ...
  const columns: ColumnDef<RoleLogType>[] = [
    {
      id: "sl",
      header: "SL",
